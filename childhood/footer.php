<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                  <?php echo do_shortcode('[contact-form-7 id="174" title="Форма вопросов"]'); ?>
                </div>
            </div>
        </div>
        <footer>
                    ...
                    <div class="col-lg-3">
                        <a href="<?php echo get_home_url(); ?>" class="footer__logo">
                            <img src="<?php
                              ...
                              ?>" alt="мир детства" class="footer__logo-img">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('tel_one', 2) ?>"><?php the_field('tel_one', 2) ?></a>
                                    <a href="tel:<?php the_field('tel_two', 2) ?>"><?php the_field('tel_two', 2) ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
