...
<div class="contacts">
    <h1 class="title">
        <?php the_field('main_location') ?>
    </h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <?php the_field('main_location-text') ?>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:<?php the_field('tel_one', 2) ?>">
                                    <?php the_field('tel_one', 2) ?>
                                </a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:<?php the_field('tel_two', 2) ?>">
                                    <?php the_field('tel_two', 2) ?>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="173" title="Форма отзывов"]'); ?>
                </div>
            </div>
        </div>
        <div class="row mt70">
                            ...
                            ?>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                            <?php the_field('main_review-name') ?>
                                        </div>
                                        <div class="feedslider__text">
                                            <?php the_field('main_review-text') ?>
                                        </div>
                                    </li>    
                            <?php
                                }
