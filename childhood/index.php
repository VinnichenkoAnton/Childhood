                ...
                <?php 
                    ...
                    foreach( $posts as $post ){
                        ...
                        ?>
                            ...
                            <li style="background-image: url('<?php the_field('mainscreen_slider-img'); ?>')" class="glide__slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-7 offset-1">
                                            ...
                                            style="
                                            <?php
                                                $field = get_field('mainscreen_slider-color');
                                            ...
                                            <?php
                                                $field = get_field('mainscreen_slider-btn');

                                                if($field == 'on') {
                                                    ?>
                                                        <a href="<?php the_field('mainscreen_slider-link') ?>" class="button">Узнать больше</a>
                                                    <?php
                                                }
                                            ?>
